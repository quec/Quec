...
class Values {
    ...
    private static final File SRCFILE = new File(System.getProperty("user.home") + "/.quec");
    ...
    public static final File SETTINGSFILE = new File(SRCFILE, "settings.properties");
    ...
    static final File[] INSTALLABLEFILES = new File[] {SRCFILE, COOKIESFILE, BOOKMARKFILE, VISITEDPAGESFILE, SETTINGSFILE, USERDATAFILE, EXTENSIONSFILE};
